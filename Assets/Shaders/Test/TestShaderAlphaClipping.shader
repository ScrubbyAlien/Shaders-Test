Shader "Custom/TestShaderAlphaClipping"
{
    Properties
    {
    ...
    SubShader
    {
        Tags
        {
            ...
            "RenderType" = "Opaque"
            "Queue" = "AlphaTest" // keep as "Transparent" to support transparancy and clipping
        }
        ...
        Pass
        {
            ...
            half4 Fragment(VertexOutput output) : SV_Target {
                float4 fragmentColor = SAMPLE_TEXTURE2D(_BaseTexture, sampler_BaseTexture, output.uv) * _BaseColor;
                if (fragmentColor.a <= _AlphaThreshold) discard;

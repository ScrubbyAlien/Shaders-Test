Shader "Custom/TestShaderDepthTesting"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            ZWrite On // decides whether this shader will write to the z-buffer
            ZTest LEqual // decides which operator should be used for testing
